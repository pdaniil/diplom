  ...
  <div class="content_place_ordering">
      <div class="payment">
        <div class="payment_node">
          <RadioButton name="delivery" value="Наличными при получении" v-model="paymentType" /> Наличными при получении
        </div>
        <div class="payment_node">
          <RadioButton name="delivery" value="Картой при получении" v-model="paymentType" /> Картой при получении
        </div>
      </div>
