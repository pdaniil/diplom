  ...
  <div class="content_place_ordering">
    <div class="delivery">
      <div class="delivery_node">
        <RadioButton name="delivery" value="Самовывоз" v-model="deliveryType" /> Самовывоз
        <div class="node_description">
          Забрать товар можно будтет в одной из указанных точек выдачи нашего магазина.
        </div>
      </div>
      <div class="delivery_node">
        <RadioButton name="delivery" value="Доставка по адресу" v-model="deliveryType" /> Доставка по адресу
        <div class="node_description">
    ...
    <div class="nav_bottom">
      ...
      <UserButton :type="'confirm'" :text="'Способ оплаты'" @click="this.$router.push('/cart/payment')"></UserButton>
    </div>
  </div>
